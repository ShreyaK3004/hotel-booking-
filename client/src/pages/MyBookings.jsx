      ...
      <div className='max-w-6xl mt-8 w-full text-gray-800'>
        ...
        {bookings.map((booking) => (
          ...
          >
            ...
            {/* Date and Time */}
            <div className='flex flex-row md:flex-col md:items-start md:gap-3 mt-4 md:mt-0'>
              <div>
            ...
            <div className='flex flex-col items-start justify-center pt-3 md:pt-0'>
              ...
              {! booking.isPaid && (
                <button className='px-4 py-1.5 mt-4 text-xs border border-gray-400 rounded hover:bg-gray-50 transition-all cursor-pointer'>
                    Pay Now
