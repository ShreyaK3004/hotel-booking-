    ...
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        mx-auto mt-16 max-w-6xl'>
          ...
          md:items-center gap-4 md:gap-10 text-gray-500'>
            ...
            <div className='flex flex-col'>
              ...
              <input type="date" id='checkInDate' placeholder='Check-In' className='w-full rounded border-gray-300
      ...
      <div className='max-w-3xl border-gray-300 my-15 py-10 text-gray-500'>
         <p>Guests will be allocated on the ground floor according to availability.
          ...
          You get the comfortable two apartment that has a true city feeling.
         </p>
      </div>
       {/*Hosted by */}
      ...
      transition-all cursor-pointer'> Contact Now
