  ...
  return (
    <div className='flex flex-col items-center px-6md:px-16 lg:px-24 xl:px-32 pt-20 pb-30'>
        <div className='flex flex-col md:flex-row items-center justify-between w-full'>
            <Title align='left' title='Exclusive Offers' subTitle='Take advantages of our limited-time offers and
        ...
        <div className='grid grid-clos-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12'>
            {exclusiveOffers.map((item)=>(
                <div key={item._id} className='group realtive flex flex-col items-start
                justify-between gap-1 pt-12 md:pt-18 px-4 rounde-xl text-white
