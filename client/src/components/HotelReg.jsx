        ...
        <form className='flex bg-white rounded-xl max-w-4xl max:md:mx-2'>
            ...
            <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
                ...
                {/*phone*/}
                 <div className='w-full mt-4'>
                    <label htmlFor="contact" className='font-medium text-gray-500'>
                        ...
                        <input id='contact' placeholder="Type here" className='border
                        border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500
                        font-light' required> 
                        </input>
                ...
                <div className='w-full mt-4 max-w-60 mr-auto'>
                    ...
                    px-3 py-2.5 mt-2 outline-indigo-500 font-light' required>
                ...
                <button className='bg-indigo-500 hover:bg-indigo-600transition-all
